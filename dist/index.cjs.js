...
var Icon$z = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/tokens/mooping-token.png" })));
};
...
var DefaultSeparator = React__default['default'].createElement(Icon$M, { color: "currentColor", width: "24px" });
...
styled.keyframes(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"], ["\n\t0% {\n\t\ttransform: translatey(0px);\n\t}\n\t50% {\n\t\ttransform: translatey(10px);\n\t}\n\t100% {\n\t\ttransform: translatey(0px);\n\t}\n"])));
...
var RotatingSpinnerIcon = styled__default['default'](SpinnerIcon)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 128 : _b;
    return (React__default['default'].createElement(Container$3, null,
        React__default['default'].createElement(RotatingSpinnerIcon, { width: size * 0.5 + "px" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 100 22" }, props),
        React__default['default'].createElement("image", { width: "100", height: "22", href: 'images/LogoText.png' }))
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Icon$E, { className: "mobile-icon" }),
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React__default['default'].createElement(Icon$W, null) : React__default['default'].createElement(Icon$X, null)),
...
styled__default['default'].a(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React__default['default'].createElement(Icon$G, { color: "primary", mr: "6px" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$H, { width: "20px", color: "primary", ml: "4px" }),
...
exports.AddIcon = Icon$_;
exports.Alert = Alert;
exports.ArrowBackIcon = Icon$Z;
exports.ArrowDownIcon = Icon$Y;
exports.ArrowDropDownIcon = Icon$X;
exports.ArrowDropUpIcon = Icon$W;
exports.ArrowForwardIcon = Icon$V;
exports.AutoRenewIcon = Icon$U;
exports.BackgroundImage = BackgroundImage;
exports.BaseLayout = GridLayout$1;
exports.BinanceIcon = Icon$T;
exports.BlockIcon = Icon$10;
exports.Breadcrumbs = Breadcrumbs;
exports.BunnyPlaceholderIcon = Icon$S;
exports.Button = Button;
exports.ButtonMenu = ButtonMenu;
exports.ButtonMenuItem = ButtonMenuItem;
exports.CalculateIcon = Icon$Q;
exports.Card = Card;
exports.CardBody = CardBody;
exports.CardFooter = CardFooter;
exports.CardHeader = CardHeader;
exports.CardRibbon = CardRibbon;
exports.CardViewIcon = Icon$R;
exports.CardsLayout = GridLayout;
exports.Checkbox = Checkbox;
exports.CheckmarkCircleIcon = Icon$12;
exports.CheckmarkIcon = Icon$P;
exports.ChevronDownIcon = Icon$O;
exports.ChevronLeftIcon = Icon$N;
exports.ChevronRightIcon = Icon$M;
exports.ChevronUpIcon = Icon$L;
exports.CloseIcon = Icon$K;
exports.CogIcon = Icon$J;
exports.CommunityIcon = Icon$I;
exports.CopyIcon = Icon$H;
exports.Dropdown = Dropdown;
exports.ErrorIcon = Icon$11;
exports.Flex = Flex;
exports.Heading = Heading;
exports.HelpIcon = Icon$G;
exports.IconButton = IconButton;
exports.Image = Image;
exports.InfoIcon = Icon$$;
exports.Input = Input$1;
exports.Link = Link;
exports.LinkExternal = LinkExternal;
exports.ListViewIcon = Icon$F;
exports.LogoIcon = Icon$E;
exports.LogoRoundIcon = Icon$D;
exports.Menu = Menu;
